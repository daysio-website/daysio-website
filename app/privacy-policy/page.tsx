          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              <p className="text-muted-foreground leading-relaxed">
                株式会社DAYSIO（以下、当社）は、健診システム提供業務において取得する顧客等の個人情報と当社従業者の個人情報を適切に管理することが重要な社会的責務であると認識し、個人情報保護方針を定めて、従業者に周知徹底を図り、個人情報の保護に努めます。
              </p>
            </section>
            ...
            <section>
              ...
              <div className="bg-muted p-6 rounded-lg">
                <p className="font-semibold mb-2">株式会社DAYSIO 個人情報保護担当</p>
            ...
            <div className="text-right mt-12">
              ...
              <p className="text-muted-foreground mt-2">株式会社DAYSIO</p>
