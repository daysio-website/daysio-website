...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-14 sm:h-16 items-center justify-between max-w-5xl mx-auto px-4">
        <a href="https://www.daysio.co.jp/" className="flex items-center flex-shrink-0">
        ...
        <div className="hidden sm:flex items-center gap-4">
          <Button asChild className="px-4 sm:px-8 min-w-max bg-[#1e3a5f] hover:bg-[#2c4f7c] text-white">
      ...
      {isMenuOpen && (
        <div className="md:hidden border-t border-border/40 bg-background">
          <nav className="container max-w-5xl mx-auto px-4 py-4 flex flex-col gap-4">
            ...
            <Button asChild className="w-full bg-[#1e3a5f] hover:bg-[#2c4f7c] text-white mt-2">
              <a href="https://www.daysio.co.jp/consultation" target="_blank" rel="noopener noreferrer">
                無料相談
              </a>
            </Button>
